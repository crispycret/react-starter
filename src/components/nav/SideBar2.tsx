...
export const SideBar2 = (props: any) => {
  ...
  function toggle() {
    if (bodyRef !== null && bodyRef.current != null) {
      bodyRef.current.classList.toggle('msb-x')
    }
  }
        ...
        <div className="container-fluid">
          <div className="navbar-header">
            ...
            <div style={{padding: '15px 0'}}>
              <a href="#" id="msbo" onClick={toggle}>
                <i className="ic fa fa-bars"></i></a>
            </div>
          </div>
          <div id="navbar" className="navbar-collapse collapse">
            <ul className="nav navbar-nav navbar-right">
              ...
              <li className="dropdown">
                <a href="#" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Draude Oba 
